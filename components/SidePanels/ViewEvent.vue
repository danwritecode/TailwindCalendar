          ...
          <div v-if="animationToggle" class="w-screen max-w-md">
            <div class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl">
              <div class="flex-1 h-0 overflow-y-auto">
                ...
                <div v-if="formState === 'View'" class="px-4 py-5">
                  <dl>
                    <div class="mt-4">
                  ...
                  <div class="px-4 divide-y divide-gray-200 sm:px-6">
                    <div class="space-y-6 pt-6 pb-5">
                      ...
                      <div class="space-y-1">
                        ...
                        <div class="relative rounded-md shadow-sm">
                          <input v-model="event.Title" id="event_title" class="form-input block w-full sm:text-sm sm:leading-5 transition ease-in-out duration-150">
                        </div>
                      </div>
                      <div class="space-y-1">
                        <label for="project_name" class="block text-sm font-medium leading-5 text-gray-900">
                        ...
                        <div class="relative rounded-md shadow-sm">
                          <input v-model="event.Body" id="event_body" class="form-input block w-full sm:text-sm sm:leading-5 transition ease-in-out duration-150">
                        </div>
                      </div>
                    </div>
                  </div>
...
export default {
  ...
  computed: {
    dateTimeHour: function() {
      return new Date(this.event.DateTime).getHours()
    },
    dateTimeMinute: function() {
      return new Date(this.event.DateTime).getMinutes()
    }
  },
  created() {
